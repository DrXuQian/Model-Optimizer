...
HF_COMMIT_MESSAGE="${HF_COMMIT_MESSAGE:-Upload layerwise global-budget NVFP4 export}"

"$REPO_ROOT/experimental/nvfp4_scale_inflation/run_export_layerwise_global_budget_hf.sh"
